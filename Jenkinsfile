...
pipeline {
    ...
    stages  {
        ...
        stage("build-image") {
            ...
            steps {
                sh 'docker build . -t enablementprojects/tmem-auth:latest'
            }
        }
        ...
        stage("push-image") {
            ...
            steps {
                sh 'docker push enablementprojects/tmem-auth'
            }
 	    }
        ...
        stage("deploy-image") {
            ...
            steps {
                sh 'kubectl rollout restart deployment/tmem-auth  --namespace=tmem'
            }
         }
    }
